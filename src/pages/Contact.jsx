      ...
      <div className="pt-16">
        ...
        <section className="py-20 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <p className="text-xl opacity-90">Get in touch with our team to discuss your IT procurement needs.</p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {[
                {
                  icon: <Phone className="w-8 h-8 text-primary-blue" />,
                  title: "Call Us",
                  details: [
                    "+971 4 123 4567",
                    "+971 50 987 6543"
                ...
                {
                  icon: <Mail className="w-8 h-8 text-primary-green" />,
                  title: "Email Us",
                  details: [
                    "info@optimity.com",
                    "sales@optimity.com"
            ...
            <div className="max-w-4xl mx-auto">
              <AnimatedSection className="bg-white rounded-lg shadow-lg overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2">
                  <div className="bg-gradient-to-br from-primary-blue to-blue-800 p-8 text-white">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-primary-yellow mr-3 mt-1" />
                    ...
                    {isSubmitted ? (
                      ...
                      <form onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                          <div>
                            ...
                            <input
                              ...
                              required
                              className="w-full px-4 py-2 border bg-white border-gray-300 rounded-md focus:ring-primary-blue focus:border-primary-blue"
                            />
                          </div>
                          <div>
                        ...
                        <button
                          ...
                          className={`w-full btn-primary bg-yellow-500 flex items-center justify-center ${
